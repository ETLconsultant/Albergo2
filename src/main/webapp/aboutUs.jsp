	...
	<div>
		<h3 id="centrato"> GRUPPO 2: NON UN SEMPLICE HOTEL </h3>
			<p id="storia">
				...
				diverso da un semplice edificio: fiducia, professionalità, cortesia e simpatia.    
				
				Vuoi prenderti del tempo per rilassarti? Hai in programma un meeting aziendale ma
				non hai bisogno di una location attrezzata? L'hotel Gruppo 2 è la scelta giusta!  
			</p>
	</div>
